        ...
        <div class="card-header card-header-primary">
          <div class="row">
            <div class="col-12 col-xl-9 col-lg-8">
              ...
              <p class="card-category">Listing of all Processes with Status and Actions filed to your Department</p>
            </div>
          </div>
        </div>
        <div class="card-body">
        ...
        <div class="card-header card-header-primary">
          <div class="row">
            <div class="col-12 col-xl-9 col-lg-8">
              ...
              <p class="card-category">Listing of all Processes with Status filed by You</p>
            </div>
            <?php
              if ( $_SESSION['userType'] != 'admin' )
              {
            ...
            <div class="col-12 col-xl-3 col-lg-3">
                <button class="card-title btn btn-success pl-0 mt-1" data-toggle="modal" data-target="#createComplaintModal"><i class="material-icons pl-3 pr-2">add</i>New Process</button>
            </div>
            <?php
              }
            ?>
