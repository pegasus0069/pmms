...
<head>
    ...
    <link rel="apple-touch-icon" sizes="76x76" href="http://directory.iub.edu.bd/img/iub_logo.png">
    <link rel="icon" type="image" href="http://directory.iub.edu.bd/img/iub_logo.png">
    
    <title>PMMS | Welcome</title>
